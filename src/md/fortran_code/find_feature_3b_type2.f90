...
!        feat_all,dfeat_allR,nfeat0m,m_neigh,n3b1m,n3b2m,nfeat_atom)
      ...
      integer ind_f(3,m_neigh,ntype,natom)
      real*8 f32(3),df32(3,2,3)
...
!ccccccccccccccccccccccccccccccccccccccccc
      ...
      feat3=0.d0   ! avtually, the nfeatm is too big !
      dfeat3=0.d0
...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      ind_f(2,j,itype,iat)=1    ! a place holder, no effect
      ...
      ind_f(3,j,itype,iat)=1    ! a place holder, no effect
      dfeat3_tmp(3,j,itype,:)=0.d0
      endif
