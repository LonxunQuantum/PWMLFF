module calc_ftype2
    ...
    integer num_step, natom, i, j,natom2,m_neigh2
...
subroutine set_image_info_type2(atom_type_list,is_reset,natom_tmp)
...
subroutine gen_feature_type2(AL,xatom)
    integer(4)  :: itype,i,j
    ...
    allocate(list_neigh_alltypeM2(m_neigh,natom))
    allocate(num_neigh_alltypeM2(natom))
    ...
    allocate(feat(nfeat0m,natom_n))
    allocate(dfeat(nfeat0m,natom_n,m_neigh,3))
    allocate(feat_M2(nfeat0m,natom_n))
    allocate(dfeat_M2(nfeat0m,natom_n,m_neigh,3))
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     nfeat0M2=nfeat0m    ! the number of featur
