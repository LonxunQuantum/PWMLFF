...
! ****************** read vdw ************************
      ...
      if(ntype_t.ne.ntype) then
         write(6,*) "ntype not same in vdw_fitB.ntype,something wrong"
         stop
      endif
      do itype1=1,ntype
...
!        real*8, intent(in) :: dfeat(nfeat0_tmp,natom_tmp,m_neigh_tmp,3)
      ...
      enddo
      ! write(*,*) "energy_pred_tmp",energy_pred_tmp
      ...
      ! write(*,*) "force_pred_tmp",force_pred_tmp
