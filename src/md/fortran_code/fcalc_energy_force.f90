subroutine calc_energy_force(n_atom, type_atom, lat, x_frac, e_atom, f_atom)
    integer, intent(in) :: n_atom
    integer, dimension(n_atom), intent(in) :: type_atom
    real*8, dimension(3,3), intent(in) :: lat
    real*8, dimension(n_atom,3), intent(in) :: x_frac
    real*8, dimension(n_atom), intent(out) :: e_atom
    real*8, dimension(n_atom,3), intent(out) :: f_atom
    ...
    allocate(E_tot_predict(num_atoms))
