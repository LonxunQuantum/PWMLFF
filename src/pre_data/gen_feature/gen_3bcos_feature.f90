...
! This num_neigh_alltype(iat) include itself !
      ...
      ! call find_feature_3bcos_type_embedding(natom,itype_atom,Rc_type,n3b_type,eta_type,w_type,alamda_type,num_neigh,  &
      !    list_neigh,dR_neigh,iat_neigh,ntype, &
      !    feat,dfeat,nfeat0m,m_neigh,n3bm,nfeat_atom, normalization_coeff)
!cccccccccccccccccccccccccccccccccccccccccccccccccccc
!cccccccccccccccccccccccccccccccccccccccccccccccccccc
!cccccccccccccccccccccccccccccccccccccccccccccccccccc
!cccccccccccccccccccccccccccccccccccccccccccccccccccc
...
!TODO:
      ...
      do i=1,natom
         write(55,"(i5,',',i3,',',E18.10,',', i3, ',',<nfeat0m>(E24.10))")  &
