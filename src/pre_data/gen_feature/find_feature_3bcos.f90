...
subroutine find_feature_3bcos_type_embedding(natom,itype_atom,Rc,n3b,eta,w,alamda, &
   num_neigh,list_neigh, &
   dR_neigh,iat_neigh,ntype,&
   feat_all,dfeat_allR,nfeat0m,m_neigh,n3bm,nfeat_atom, normalization_coeff)
   implicit none
   integer ntype
   integer natom,n2b,n3b(ntype)
   integer nfeat0m,m_neigh,itype0
   ...
   do 5000 iat=1,natom
      ...
      do itype2 = 1, ntype
         do itype1 = 1, itype2
            ...
            do kk=1,n3b(itype0)
               feat3(kk,itype12,iat) = feat3(kk,itype12,iat) * normalization_coeff12(itype1,itype2)
               dfeat3(kk,itype12,iat,1:nneigh,:) = dfeat3(kk,itype12,iat,1:nneigh,:) * normalization_coeff12(itype1,itype2)
            enddo
         enddo
      enddo
...
5000 continue
   ...
   return
end subroutine find_feature_3bcos_type_embedding
