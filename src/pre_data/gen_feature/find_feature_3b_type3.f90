...
subroutine find_feature_3b_type3_type_embedding(natom,itype_atom,Rc,Rc2,n3b1,n3b2, &
   num_neigh,list_neigh, &
   dR_neigh,iat_neigh,ntype,grid31_2,grid32_2, &
   feat_all,dfeat_allR,nfeat0m,m_neigh,n3b1m,n3b2m,nfeat_atom, normalization_coeff)
   implicit none
   integer ntype
   integer natom,n2b,n3b1(ntype),n3b2(ntype)
   integer nfeat0m,m_neigh,itype0
   ...
   real(8) :: normalization_coeff(ntype)
   real(8) :: normalization_coeff12(ntype,ntype)
...
3000 continue
   ...
   do 5000 iat=1,natom
      ...
      do itype2 = 1, ntype
         do itype1 = 1, itype2
            itype12 = itype1 + ((itype2-1)*itype2)/2
            normalization_coeff12(itype1,itype2) = normalization_coeff(itype1) + ((normalization_coeff(itype2-1))*normalization_coeff(itype2))/2
            ...
            do k1 = 1, n3b1(itype0)
               do k2 = 1, n3b1(itype0)
                  do k12 = 1, n3b2(itype0)
                     ...
                     if(ii_f.gt.0) then
                        feat3(ii_f,itype12,iat) = feat3(ii_f,itype12,iat) * normalization_coeff12(itype1,itype2)
                        dfeat3(ii_f,itype12,iat,1:nneigh,:) = dfeat3(ii_f,itype12,iat,1:nneigh,:) * normalization_coeff12(itype1,itype2)
                     endif
            ...
            do k12=1,n3b2(itype0)
               ...
               do itype2=1,ntype
                  do itype1=1,itype2
                     ...
                     if(ii_f.gt.0) then
                        feat_all(num,iat)=feat_all(num,iat) + feat3(ii_f,itype12,iat)
                        if (abs(feat_all(num,iat)).lt.1E-38) then
                           feat_all(num,iat)=0.d0
                        endif
                        dfeat_all(num,iat,1:nneigh,:)=dfeat_all(num,iat,1:nneigh,:) + dfeat3(ii_f,itype12,iat,1:nneigh,:)
                     endif
...
5000 continue
   ...
   return
end subroutine find_feature_3b_type3_type_embedding
