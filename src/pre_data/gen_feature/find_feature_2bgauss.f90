...
subroutine find_feature_2bgauss_type_embedding(natom,itype_atom,Rc,n2b, &
   num_neigh,list_neigh, &
   dR_neigh,iat_neigh,ntype,grid2,wgauss, &
   ...
   do 5000 iat=1,natom
      ...
      do k=1,n2b(itype0)
         ...
         do itype=1,ntype
            ...
            ! dfeat_all(num,iat,1:nneigh,:)=dfeat2(k,itype,iat,1:nneigh,:)
            dfeat_all(num,iat,1:nneigh,:)=dfeat_all(num,iat,1:nneigh,:) + dfeat2(k,itype,iat,1:nneigh,:)
         enddo
      enddo
...
5000 continue
   ...
   return
end subroutine find_feature_2bgauss_type_embedding
