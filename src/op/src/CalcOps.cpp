...
torch::autograd::variable_list CalculateNepFeatFuncs::backward(
    ...
    at::Tensor atom_map) 
    {
        ...
        // printf("======5 returns ===========");
        return {grad_coeff2, grad_d12_radial, torch::autograd::Variable(), torch::autograd::Variable(), torch::autograd::Variable()}; // f2的梯度 coeff的梯度 因为不需要，所以不计算，只占位
    }
...
// nep 3b feature
torch::autograd::variable_list CalculateNepFeat3bFuncs::forward(
    at::Tensor coeff2,
    at::Tensor d12_radial,
    at::Tensor NL_radial,
    at::Tensor atom_map,
...
torch::autograd::variable_list CalculateNepFeat3bFuncs::backward(
    torch::autograd::variable_list grad_output,
    at::Tensor coeff2,
    at::Tensor d12_radial,
    at::Tensor dfeat_c2,
...
torch::autograd::variable_list CalculateNepFeat3b::forward(
    torch::autograd::AutogradContext *ctx,
    at::Tensor coeff2,
    at::Tensor d12_radial,
    at::Tensor NL_radial,
    ...
    double rcut_radial) 
    {
        auto results = CalculateNepFeat3bFuncs::forward(coeff2, d12_radial, NL_radial, atom_map, rcut_radial);
        auto feat_2b = results[0];
        auto dfeat_c2 = results[1];
        auto dfeat_2b = results[2];
        ctx->save_for_backward({coeff2, d12_radial, dfeat_c2, dfeat_2b, atom_map});
...
torch::autograd::variable_list CalculateNepFeat3b::backward(
    torch::autograd::AutogradContext *ctx,
    torch::autograd::variable_list grad_output) 
    {
        auto saved = ctx->get_saved_variables();
        ...
        auto dfeat_2b = saved[3];
        auto atom_map = saved[4];
        return CalculateNepFeat3bFuncs::backward(grad_output, coeff2, d12_radial, dfeat_c2, dfeat_2b, atom_map);
    }
...
torch::autograd::variable_list calculateNepFeat3b(
    ...
    double rcut_radial) 
    {
        return CalculateNepFeat3b::apply(coeff2, d12_radial, NL_radial, atom_map, rcut_radial);
    }